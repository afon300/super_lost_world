...
button_size_menu = (270, 100)
button_size_option = (235, 150)
resume_img = pygame.transform.scale(resume_img, button_size_menu)
options_img = pygame.transform.scale(options_img, button_size_menu)
quit_img = pygame.transform.scale(quit_img, button_size_menu)
video_img = pygame.transform.scale(video_img, button_size_option)
audio_img = pygame.transform.scale(audio_img, button_size_option)
keys_img = pygame.transform.scale(keys_img, button_size_option)
back_img = pygame.transform.scale(back_img, button_size_option)
...
video_button = button.Button(350, 225, video_img, 1)
audio_button = button.Button(650, 225, audio_img, 1)
keys_button = button.Button(350, 425, keys_img, 1)
back_button = button.Button(650, 425, back_img, 1)
