...
button_size_menu = (200, 100)
button_size_option = (400, 100)
...
video_img = pygame.transform.scale(video_img, button_size_menu)
audio_img = pygame.transform.scale(audio_img, button_size_menu)
keys_img = pygame.transform.scale(keys_img, button_size_menu)
back_img = pygame.transform.scale(back_img, button_size_menu)
